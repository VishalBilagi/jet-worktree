...
contextBridge.exposeInMainWorld("jet", {
  ...
  listBranches: (repoPath: string) => ipcRenderer.invoke("jet:list-branches", repoPath),
  addWorktree: (repoPath: string, branch: string, base?: string) => ipcRenderer.invoke("jet:add-worktree", repoPath, branch, base),
